$(function(){
	...
	var socket = io('ws://10.33.134.77:8081');
	/*定义用户名*/
	var uname = null;
	...
	socket.on('users',function(users){
		...
		for(var i=0;i<users.length;i++){
		    if(users[i].username.indexOf("群聊")!==-1){
                head="../images/user/group.png";
            }else {
                head="../images/user/user.jpg";
            }
